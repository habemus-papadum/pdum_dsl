...
from ..kernel.capture import make_handle
from ..kernel.ops import PURE, OpDef
from ..kernel.registry import Registry
from ..kernel.types import Record, Type, boolean, f64, i64
...
def _invalidate(registry: Registry) -> None:
    ...
    from ..kernel.cache import ArtifactCache
